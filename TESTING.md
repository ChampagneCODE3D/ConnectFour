...
| UI-04 | Name edit behavior | Use backspace and spaces in name | Name input edits correctly, normalized spacing | [x] Pass / [ ] Fail |
| UI-05 | Name length limit | Enter name with 51+ chars | Error shown, prompt retries | [x] Pass / [ ] Fail |
| UI-06 | Esc in name prompt | Press `Esc`, return to prompt | Return keeps setup flow active | [x] Pass / [ ] Fail |
...
| UI-13 | Horizontal win | Play sequence to create horizontal 4 | Winner banner shown | [x] Pass / [ ] Fail |
| UI-14 | Vertical win | Play sequence to create vertical 4 | Winner banner shown | [x] Pass / [ ] Fail |
| UI-15 | Diagonal win | Play sequence to create diagonal 4 | Winner banner shown | [x] Pass / [ ] Fail |
| UI-16 | Draw | Fill board with no 4-in-a-row | Draw banner shown | [x] Pass / [ ] Fail |
| UI-17 | Replay yes | End game, enter `y` | Returns to menu/start screen | [x] Pass / [ ] Fail |
| UI-18 | Replay no | End game, enter `n` | Goodbye + exits cleanly | [x] Pass / [ ] Fail |
| UI-19 | Esc in replay prompt | Press `Esc` at replay prompt | Exit menu appears with return/exit choices | [x] Pass / [ ] Fail |
| UI-20 | AI behavior by difficulty | Observe Easy vs Medium vs Hard rounds | Easy random, Medium win/block, Hard stronger positioning | [x] Pass / [ ] Fail |
